      ...
      {i == 0 ? (
        ...
        i < steps.length ? (
          <div className="py-6 sm:py-8 lg:py-12 max-w-screen-2xl px-4 md:px-8 mx-auto min-h-screen">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-4 gap-x-4 md:gap-x-6 gap-y-8 my-8">
              {components && components.length > 0
                      ...
                      {product.slug.current && (
                        <div className="flex flex-col">
                              ...
                              {product.images && product.images.length > 0 ? (
                                <img
                                  ...
                                  className={`w-full h-full object-cover object-center rounded-lg group-hover:scale-110 transition duration-200 border-8 border-solid ${
                                    product === currentSelectedComponent
                                      ? "border-[#b4a07c] shadow-lg shadow-[#b4a07c]"
                                      : ""
                                  }`}
                                />
                              ) : (
                          ...
                          <div className="info mt-4">
                            <div className="-my-4 text-[#b4a07c] text-xl font-bold hover:gray-800 transition duration-100">
                              {product.name}&nbsp;
                            </div>
                            <br />
            ...
            {isMobile && (
              <div>
                <button className="p-3 hover:cursor-pointer bg-[#b4a07c] hover:bg-[#5c5240] text-black hover:text-white hover:no-underline text-base font-semibold rounded-lg transition-colors duration-300 transform" onClick={handleNextClick}>
                  Siguiente
                </button>
              </div>
            )}
